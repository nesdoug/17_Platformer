...
;
	...
	sec
	sbc     _eject_R
L07A6:	sta     _BoxGuy1+1
;
; if(BoxGuy1.vel_y < 0x300){
;
L061C:	lda     _BoxGuy1+6
	cmp     #$00
	lda     _BoxGuy1+6+1
	sbc     #$03
	bvc     L0626
...
;
L06D6:	ldy     _coordinates
	lda     _c_map2,y
L07BD:	sta     _collision
;
